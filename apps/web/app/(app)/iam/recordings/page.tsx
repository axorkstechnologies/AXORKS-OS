  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex flex-wrap items-center gap-2.5">
            <h1 className="text-xl font-bold tracking-tight text-slate-900 dark:text-slate-100 flex items-center gap-2">
              <Video className="w-5 h-5 text-violet-500" /> Employee Screen & Call Recording Studio
            </h1>
            <span className="px-2.5 py-0.5 rounded-full text-xs font-mono font-bold bg-amber-500/10 text-amber-400 border border-amber-500/30 flex items-center gap-1">
              <Crown className="w-3 h-3 text-amber-500" /> Executive Surveillance
            </span>
          </div>
        ...
        {/* Expiry Policy Badge */}
        <div className="inline-flex items-center gap-2 px-3.5 py-2 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-xs text-amber-400 font-semibold shadow-sm">
      ...
      <div className="bg-slate-900/70 p-6 rounded-3xl border border-slate-800 shadow-2xl space-y-6 backdrop-blur-md">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-4">
          ...
          <div className="flex items-center gap-2.5 bg-slate-950 px-3.5 py-1.5 rounded-2xl border border-slate-800">
            <User className="w-3.5 h-3.5 text-violet-400 shrink-0" />
            <span className="text-xs font-semibold text-slate-400">Target Employee:</span>
            <select
